...
$action = (isset($_POST["action12"])&& $_POST["action12"] !=NULL)?$_POST["action12"]:"";
if($action == "ajax12"){

	require(__ROOT6__."/class.filtro12.php");
	$database=new orders();	
...
echo '<script>
    document.getElementById("INCI-registros").innerHTML = "<span class=\'circulo-contador\'>' . $numrows . '</span>";
</script>';
			?>
        </div>
	<?php
