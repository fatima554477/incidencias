...
<option style="background:#c2faaa" value="RESUELTO" '.$RESUELTO.'>RESUELTO</option>
        ...
        // Extract only the name from DOCUMENTO_INCIDENCIAS
        $documentoIncidenciasNombre = $row["DOCUMENTO_INCIDENCIAS"];
        $documentoIncidenciasPartes = explode('^^', $documentoIncidenciasNombre);
        $documentoIncidenciasNombre = end($documentoIncidenciasPartes);
...
<td width="70%">'.$documentoIncidenciasNombre.'</td>
</tr>
<tr>
   ...
   $.ajax({  
    ...
    success:function(data){
        ...
        if($.trim(data)=='Ingresado' || $.trim(data)=='Actualizado'){
            ...
            $("#mensajeINCIDctualiza2")
                .html("<span id='ACTUALIZADO'>"+data+"</span>")
                .fadeIn()
                .delay(2000)   // <-- 4 segundos
                .fadeOut();    // se desaparece solo
